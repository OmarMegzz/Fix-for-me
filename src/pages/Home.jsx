...
function Home({ scrollToForm }) {
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/images/mianImg.png')",
    ...
    >
      ...
      <div className="relative z-10 flex flex-col gap-6 max-w-3xl">
        ...
        <p className="text-gray-600 text-lg sm:text-xl font-medium">
          صلّحلي بتقدملك خدمة صيانة سهلة وسريعة من باب بيتك لباب بيتك، تريحك
          وتوفّرلك وقتك ومجهودك، وكمان بأمان تام وضمان على الخدمة
        </p>
